...
export default function DrawerTagsMobile({
  tags,
  selectedTag,
  setSelectedTag,
}: {
  ...
  return (
    <div className="sm:hidden flex items-center">
      <button
        className="flex items-center gap-2 px-3 py-2 rounded-md text-base font-bold
      ...
      {showMobileTags && (
        <>
          ...
          <aside
            ...
            className="fixed top-0 left-0 h-full w-64 shadow-2xl z-50 flex flex-col
          ...
          >
            <div className="flex items-center justify-between px-4 py-3 bg-white dark:bg-black">
              <button
                onClick={() => setShowMobileTags(false)}
                className="ml-2 sm:ml-6 rounded-full transition-colors p-1 sm:p-2
