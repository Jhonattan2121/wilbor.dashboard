...
export function useDynamicPartnersPost(username: string) {
      ...
      try {
        ...
        if (found) {
          ...
          try {
            ...
            console.log('[Partners] Tags extraídas:', postTags);
          } catch (e) {
            console.warn('Erro ao extrair tags:', e);
          }
          setTags(postTags);
        } else {
          setError('Nenhum post sobre parceiros encontrado para este usuário.');
        }
      } catch {
