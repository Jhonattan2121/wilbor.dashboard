...
export function labelForFilmSimulation(simulation: FujifilmSimulation) {
  return {
    small: FILM_SIMULATION_LABELS[simulation].small || 'HV',
    medium: FILM_SIMULATION_LABELS[simulation].medium || 'HIVE',
    large: FILM_SIMULATION_LABELS[simulation].large || 'Hive Post'
  };
}
